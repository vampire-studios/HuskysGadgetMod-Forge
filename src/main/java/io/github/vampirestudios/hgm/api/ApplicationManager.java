...
/**
 * Manages all the applications that can be added to the {@link io.github.vampirestudios.gadget.core.BaseDevice} in the device mod. Can be used to register an application with {@link #registerApplication(ResourceLocation, Class)} or to get certain applications.
 *
 * <br>
 * </br>
 *
