...
public abstract class Component extends Screen implements IRenderable {
    /**
     * The default components textures
     */
    public static final ResourceLocation COMPONENTS_GUI = new ResourceLocation("hgm:textures/gui/components.png");
     ...
     */
    public void render(BaseDevice device, Minecraft mc, int x, int y, int mouseX, int mouseY, boolean windowActive, float partialTicks) {
    }
     ...
     * @param windowActive if the window is active (at front)
     */
    protected void renderOverlay(BaseDevice device, Minecraft mc, int mouseX, int mouseY, boolean windowActive) {
    }
