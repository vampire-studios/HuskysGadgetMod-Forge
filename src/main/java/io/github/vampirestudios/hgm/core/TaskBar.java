...
public class TaskBar extends Screen {
    ...
    private static final ResourceLocation APP_BAR_GUI = new ResourceLocation("hgm:textures/gui/application_bar.png");
    ...
    public TaskBar(BaseDevice device) {
        super(new StringTextComponent("TaskBar"));
        this.device = device;
...
//        trayItems.forEach(TrayItem::tick);
    ...
    public void render(BaseDevice gui, Minecraft mc, int x, int y, int mouseX, int mouseY, float partialTicks) {
        ...
        mc.fontRenderer.drawStringWithShadow(timeToString(mc.player.world.getGameTime()), x + 414, y + 5, Color.WHITE.getRGB());
    ...
    private Layout createClockLayout() {
        ...
        Label label = new Label("Day -1", layout.width / 2, 5) {
            ...
            public void render(BaseDevice laptop, Minecraft mc, int x, int y, int mouseX, int mouseY, boolean windowActive, float partialTicks) {
                this.setText("Day " + Minecraft.getInstance().player.world.getGameTime() / 24000);
